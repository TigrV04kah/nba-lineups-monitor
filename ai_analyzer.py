...
1. **Анализ тренда ОЧКОВ (5 игр)**:
   - Запиши очки: Игра №5 → №4 → №3 → №2 → №1
...
4. **Анализ влияния СОСТАВОВ команды**:
   - Посмотри раздел "СОСТАВЫ КОМАНДЫ В ПОСЛЕДНИХ 5 ИГРАХ"
...
6. **РАСЧЁТ ПРОГНОЗА** (строгая формула):
   🔢 БАЗА = среднее очков за последние 3 игры (№1, №2, №3)
   Корректировки:
...
- ЕСЛИ для игрока указано "НЕ ИГРАЛ" → НЕ включай эту игру в расчёты

📊 ФОРМАТ ОТВЕТА:

**1. Тренд очков**: №5→№4→№3→№2→№1: [цифры]
   → Тренд: [тип], аномалии: [есть/нет]

**2. Тренд минут**: №5→№4→№3→№2→№1: [цифры]
